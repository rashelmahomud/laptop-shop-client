            ...
            <div class="modal">
                <div class="modal-box relative">
                    ...
                    <form onSubmit={handelBooking} className='grid justify-items-center'>
                        ...
                        <input type="text" name="name" disabled value={name} class="input input-bordered w-full max-w-xs m-3" />
                        <input type="text" value={cost} class="input input-bordered w-full max-w-xs m-3" />
                        <input type="text" value={Quantity} class="input input-bordered w-full max-w-xs m-3" />
                        <input type="email" name='email' value={user?.email} placeholder="Email" class="input input-bordered w-full max-w-xs m-3" />
